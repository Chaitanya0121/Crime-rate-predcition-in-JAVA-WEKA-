...
public class Lakshwadeep implements ActionListener 
{
	DataSource source;
	Instances dataset;
	Instance crimeRate;
	...
	JFrame F = new JFrame("Lakshwadeep");
	...
	{
		source = new DataSource("C:\\Users\\Chaitanya\\\\Desktop\\\\States\\\\Lakshadweep.arff");
	...
	void input()
	{
		...
		UT = new Label("Lakshwadeep",Label.CENTER);
		UT.setFont(Q);
