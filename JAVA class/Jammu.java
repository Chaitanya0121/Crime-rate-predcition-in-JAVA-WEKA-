...
public class Jammu  implements ActionListener
{
	DataSource source;
	Instances dataset;
	Instance crimeRate;
	...
	JFrame F = new JFrame("Jammu and Kashmir");
	...
	{
		source = new DataSource("C:\\Users\\Chaitanya\\\\Desktop\\\\States\\\\J&K.arff");
	...
	void input()
	{
		...
		UT = new Label("Jammu and Kashmir",Label.CENTER);
		UT.setFont(Q);
