...
public class Andaman  implements ActionListener
{
	DataSource source;
	Instances dataset;
	Instance crimeRate;
	...
	{
		source = new DataSource("C:\\Users\\Chaitanya\\\\Desktop\\\\States\\\\Andaman.arff");
	...
	void input()
	{
		...
		UT = new Label("Andaman and Nicobar",Label.CENTER);
		UT.setFont(Q);
