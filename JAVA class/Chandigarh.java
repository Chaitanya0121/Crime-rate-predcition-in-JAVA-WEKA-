...
public class Chandigarh  implements ActionListener
{
	DataSource source;
	Instances dataset;
	Instance crimeRate;
	...
	JFrame F = new JFrame("Chandigarh");
	...
	{
		source = new DataSource("C:\\Users\\Chaitanya\\\\Desktop\\\\States\\\\Chandigarh.arff");
	...
	void input()
	{
		...
		UT = new Label("Chandigarh",Label.CENTER);
		UT.setFont(Q);
