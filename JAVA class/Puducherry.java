...
public class Puducherry implements ActionListener
{
	DataSource source;
	Instances dataset;
	Instance crimeRate;
	...
	JFrame F = new JFrame("Puducherry");
	...
	{
		source = new DataSource("C:\\Users\\Chaitanya\\\\Desktop\\\\States\\\\Puducherry.arff");
	...
	void input()
	{
		...
		UT = new Label("Puducherry",Label.CENTER);
		UT.setFont(Q);
