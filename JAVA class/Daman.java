...
public class Daman implements ActionListener
{
	DataSource source;
	Instances dataset;
	Instance crimeRate;
	...
	JFrame F = new JFrame("Daman and Diu");
	...
	{
		source = new DataSource("C:\\Users\\Chaitanya\\\\Desktop\\\\States\\\\Daman&Diu.arff");
	...
	void input()
	{
		...
		UT = new Label("Daman and Diu",Label.CENTER);
		UT.setFont(Q);
		UT.setBounds(100,100,200,40);
		F.add(UT);
